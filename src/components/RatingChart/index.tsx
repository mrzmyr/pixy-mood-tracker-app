...
/**
 * One chart bucket; `value` is on the {@link RATING_MAPPING} scale and
...
/**
 * SVG line chart of average ratings.
 *
 * Values are rounded to whole rating steps before plotting. `showAverage`
 * draws the mean of non-empty buckets.
 */
